...
def main():
    ...
    parser.add_argument('command', nargs='?', type=str,
                        ...
                        default="export")
    parser.add_argument('--out_dir', type=str, default=r'E:\Datasets\lsun\lsun_church\church_outdoor_val_lmdb')
    ...
    lmdb_paths = [r'E:\Datasets\lsun\lsun_church\church_outdoor_val_lmdb']
    print(lmdb_paths)
    ...
    for lmdb_path in lmdb_paths:
        if command == 'view':
            ...
            export_images(lmdb_path, args.out_dir, True)
